...
if __name__ == '__main__':
  ...
  ╚═╝  ╚═╝╚═╝  ╚═╝ ╚══╝╚══╝ ╚═╝  ╚═╝     ╚══════╝   ╚═╝   ╚══════╝
                                        ...
                                        Made with  py️by """ + Fore.BLUE + "Fre4k\n")

    parser = argparse.ArgumentParser(description='Using an OSINT program, you may look into accounts on social '
                                                 'networks by username.')
